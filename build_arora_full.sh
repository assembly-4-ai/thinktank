...
nasm -f elf64 -I includes/ -o build/error.o core/error_pic.asm
nasm -f elf64 -I includes/ -o build/acpi_runtime.o core/acpi_runtime.asm
nasm -f elf64 -I includes/ -o build/apic.o core/apic.asm
nasm -f elf64 -I includes/ -o build/irq_handlers.o core/irq_handlers.asm
nasm -f elf64 -I includes/ -o build/irq_handlers_pic.o core/irq_handlers_pic.asm
